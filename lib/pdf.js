...
// Hard ceiling on document length, checked before extraction so very long
// PDFs are rejected quickly rather than processed in full.
...
// Cheap page-count check (no text extraction) so oversized PDFs can be
